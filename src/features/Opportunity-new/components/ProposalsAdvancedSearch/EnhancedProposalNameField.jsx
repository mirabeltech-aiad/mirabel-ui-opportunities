...
const EnhancedProposalNameField = ({ 
  label = "Proposal Name", 
  value = [], 
  onChange, 
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      ...
      const isOutsidePortal = !event.target.closest('[data-proposal-name-dropdown]');
...
export default EnhancedProposalNameField; 