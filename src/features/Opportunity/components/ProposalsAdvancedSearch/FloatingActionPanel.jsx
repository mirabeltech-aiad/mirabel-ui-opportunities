...
const FloatingActionPanel = ({ searchParams, onSearch, onClear, openAccordions, onAccordionChange }) => {
  ...
  // Define accordion sections with their labels for proposals
  const allSections = [
    { value: "primary-fields", label: "Quick Search" },
    { value: "proposal-info", label: "Proposal Info" },
    { value: "status-process", label: "Status & Process" },
    { value: "financial-commercial", label: "Financial Terms" },
    { value: "proposal-details", label: "Proposal Details" },
    { value: "client-company", label: "Client Info" },
