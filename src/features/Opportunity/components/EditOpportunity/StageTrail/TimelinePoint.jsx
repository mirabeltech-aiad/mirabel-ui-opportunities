...
const TimelinePoint = ({ change, index, stageChanges }) => {
  ...
  const stageName = change.toStage || change.stageName || change.stage || 'Unknown Stage';
  ...
  return (
    ...
    >
      ...
      >
        <Badge 
          variant="outline" 
          className={`${getStageColor(stageName)} font-medium px-4 py-2 text-sm mb-3`}
        >
          {stageName}
        </Badge>
