...
import { CirculationErrorBoundary } from '@/components/error-boundaries';

import { Skeleton } from '@/components/ui/skeleton';

// Direct lazy imports without complex fallbacks
const LazyCirculationOverview = React.lazy(() => import('./OptimizedCirculationOverview'));
const LazyInteractiveTrendsChart = React.lazy(() => import('./InteractiveTrendsChart'));
const LazyGrowthMetrics = React.lazy(() => import('./GrowthMetrics'));
const LazyChurnAnalysis = React.lazy(() => import('./ChurnAnalysis'));
const LazySubscriptionLifecycleTracker = React.lazy(() => import('./SubscriptionLifecycleTracker'));
const LazyGeographicDistribution = React.lazy(() => import('./GeographicDistribution'));
const LazyCirculationRevenueDashboard = React.lazy(() => import('./CirculationRevenueDashboard'));
